...
def visualize_cameras_and_pointcloud(poses_with_camera_id, camera_info, pointcloud_path, scale_factor=1.0, point_size=2.0):
    """
    可视化相机位姿和点云
...
if __name__ == "__main__":
    ...
    pointcloud_path = r'Dense\fused.ply'
    ...
    visualize_cameras_and_pointcloud(poses_with_camera_id, camera_info, pointcloud_path, scale_factor, point_size)
